...
When **reviewing recordings** in Parley, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Parley records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Parley recordings** - Use wired/speakers instead
...
### This is Not a Parley Bug

The issue is in **macOS's Bluetooth audio stack**, not in Parley's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Parley bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Parley now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Parley v0.0.5+ on macOS
