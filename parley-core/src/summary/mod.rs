...
// Tauri commands (`api_process_transcript` etc., template CRUD) live in the
// shell crate's `commands::summary::{commands, template_commands}` and are
// referenced that way in generate_handler!.
